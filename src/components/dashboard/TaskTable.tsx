...
export default function TaskTable({ doneTasks, notDoneTasks, showOverdueOnly = false }: TaskTableProps) {
    ...
    const getVideoTypeColor = (type: string | null) => {
        const colors: Record<string, string> = {
            ...
            S10B: 'bg-zinc-500/20 text-zinc-300',
            'Research Doc': 'bg-yellow-500/20 text-yellow-300',
            'ScreenShot': 'bg-cyan-500/20 text-cyan-300',
            'Screenshot': 'bg-cyan-500/20 text-cyan-300',
            'ScreenShot (loai 2)': 'bg-sky-500/20 text-sky-300',
            'ScreenShot (loại 2)': 'bg-sky-500/20 text-sky-300',
            'Screenshot (loai 2)': 'bg-sky-500/20 text-sky-300',
            'Screenshot (loại 2)': 'bg-sky-500/20 text-sky-300',
            'ScreenShot (loai 3)': 'bg-blue-500/20 text-blue-300',
            'ScreenShot (loại 3)': 'bg-blue-500/20 text-blue-300',
            'Screenshot (loai 3)': 'bg-blue-500/20 text-blue-300',
            'Screenshot (loại 3)': 'bg-blue-500/20 text-blue-300',
            'Icon': 'bg-lime-500/20 text-lime-300',
            'Cover, Promotional Content': 'bg-rose-500/20 text-rose-300',
            'Localize Screenshot': 'bg-emerald-500/20 text-emerald-300',
            'Localize': 'bg-green-500/20 text-green-300',
            'Deep Localize': 'bg-teal-500/20 text-teal-300',
            'Image Ads (1size)': 'bg-orange-500/20 text-orange-300',
            'Image Ads (3size)': 'bg-pink-500/20 text-pink-300',
        }
