...
import { DESIGN_POINT_CONFIG, WORKING_DAYS_PER_WEEK, isTargetDeductionDay } from '@/lib/constants'
                ...
                if (dayOffsData) {
                    ...
                    dayOffsByMemberDate.forEach((dayOff) => {
                        ...
                        if (dayOff.user_email === 'system@holiday') {
                            companyHolidayDeductionsMap[memberName][weekNum] = (companyHolidayDeductionsMap[memberName][weekNum] || 0) + deduction
                        }
                    })
                }
                                            ...
                                            return (
                                                <th
                                                    ...
                                                    style={isCurrentWeek ? {
                                                        ...
                                                        boxShadow: 'inset 0 0 12px rgba(6, 182, 212, 0.3), 0 0 8px rgba(6, 182, 212, 0.2)'
                                                    } : undefined}
                                                >
                                                    {week.label}
                                                </th>
                                                ...
                                                return (
                                                    <td
                                                        ...
                                                        style={isCurrentWeek ? {
                                                            borderLeft: '2px solid rgb(6, 182, 212)',
                                                            borderRight: '2px solid rgb(6, 182, 212)',
                                                            ...(isLastRow ? { borderBottom: '2px solid rgb(6, 182, 212)' } : {}),
